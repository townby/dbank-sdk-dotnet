...
namespace Conversive.PHPSerializationLibrary
{
	...
	public class Serializer
	{
		...
		private StringBuilder serialize(object obj, StringBuilder sb)
		{
            ...
            {
                Dictionary<Object, Object> a = (Dictionary<Object, Object>)obj;
                sb.Append("a:" + a.Count + ":{");
                foreach (KeyValuePair<Object, Object> kv in (Dictionary<Object, Object>)obj)
                {
                    this.serialize(kv.Key, sb);
                    this.serialize(kv.Value, sb);
                }
                sb.Append("}");
                return sb;
            }
		...
		private object deserialize(string str)
		{
			...
			switch(str[this.pos])
			{
				...
				case 's':
                    ...
                    int strlength = str.IndexOf(";", end)-end-3;
                    string stRet = str.Substring(end + 2, strlength);

                    this.pos += 6 + stLen.Length + strlength;
					if(this.XMLSafe)
					{
						stRet = stRet.Replace("\n", "\r\n");
					}
				...
				case 'a':
                    ...
                    Dictionary<Object, Object> dtRet = new Dictionary<object, object>();
